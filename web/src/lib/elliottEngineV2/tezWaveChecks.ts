...
/** Tez §2.5.4.1 flat_r4 — B, A dalgasının 0.382–2.618 katı aralığında olabilir. */
...
export function buildTez254AbcChecks(
  ...
  if (pattern === "flat") {
    ...
    checks.push({
      id: "flat_r4",
      passed: flatB,
      detail: `B/A=${retrB.toFixed(3)} ∈ [${TEZ_FLAT_B_VS_A_MIN}, ${TEZ_FLAT_B_VS_A_MAX}]`,
    });
    checks.push({
      id: "flat_g7",
    ...
    checks.push({
      id: "zz_r5",
      passed: retrB >= 0.382 - 1e-12 && retrB <= TEZ_ZIGZAG_B_VS_A_MAX + 1e-12,
