...
//! | `find(points, …)` (checkBarRatio, `inspect`, `ratioDiff`, `allowedPatterns`, `allowedLastPivotDirections`) | [`crate::find::try_scan_six_window`](crate::find::try_scan_six_window) + `scan_six_alternating_pivots`; filtreler [`ChannelSixWindowFilter`](crate::ChannelSixWindowFilter) |
