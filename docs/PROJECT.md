...
8. **Web UI** — grafik/Elliott temel akış + çekmece **AI → Onay kuyruğu** (`ai_approval_requests`); **Bildirimler → Şablon** (`notify_outbox` taslak/kuyruğa ekleme) + **Kuyruk** listesi (**kısmen**; PnL grafikleri / emir defteri / audit UI sonra)  
